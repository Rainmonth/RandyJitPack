...
import com.rainmonth.adapter.animation.AlphaInAnimation;
import com.rainmonth.adapter.animation.BaseAnimation;
import com.rainmonth.adapter.animation.ScaleInAnimation;
import com.rainmonth.adapter.animation.SlideInBottomAnimation;
import com.rainmonth.adapter.animation.SlideInLeftAnimation;
import com.rainmonth.adapter.animation.SlideInRightAnimation;
import com.rainmonth.adapter.diff.BaseQuickAdapterListUpdateCallback;
import com.rainmonth.adapter.diff.BaseQuickDiffCallback;
import com.rainmonth.adapter.entity.IExpandable;
import com.rainmonth.adapter.loadmore.LoadMoreView;
import com.rainmonth.adapter.loadmore.SimpleLoadMoreView;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
     ...
     * this com.rainmonth.utils.common.adapter does not care about the calculation process.
     *
    ...
    /**
     * insert  a item associated with the specified position of com.rainmonth.utils.common.adapter
     *
     * @param position
     * @param item
    ...
    /**
     * remove the item associated with the specified position of com.rainmonth.utils.common.adapter
     *
     * @param position
     */
     ...
     *
     * @param position Position of the item whose data we want within the com.rainmonth.utils.common.adapter's
     *                 data set.
    ...
    /**
     * Called when a view created by this com.rainmonth.utils.common.adapter has been attached to a window.
     ...
     * @param position The position of the item within the com.rainmonth.utils.common.adapter's data set.
    ...
    /**
     * if you want to use subclass of BaseViewHolder in the com.rainmonth.utils.common.adapter,
    ...
    /**
     * set emptyView show if com.rainmonth.utils.common.adapter is empty and want to show headview and footview
     * Call before {@link RecyclerView#setAdapter(RecyclerView.Adapter)}
     *
    ...
    /**
     * When the current com.rainmonth.utils.common.adapter is empty, the BaseQuickAdapter can display a special view
     * called the empty view. The empty view is used to provide feedback to the user
     * that no data is available in this AdapterView.
     *
     * @return The view to show if the com.rainmonth.utils.common.adapter is empty.
     */
     ...
     *
     * @param position The position of the item within the com.rainmonth.utils.common.adapter's data set whose row id we want.
...
//            subItemCount += list.size();
     ...
     * @return the number of items that have been added to the com.rainmonth.utils.common.adapter.
     */
    ...
    public interface OnItemChildClickListener {
         ...
         * @param position The position of the view int the com.rainmonth.utils.common.adapter
         */
    ...
    public interface OnItemChildLongClickListener {
         ...
         * click and held
         *
         * @param adapter  this BaseQuickAdapter com.rainmonth.utils.common.adapter
    ...
    public interface OnItemClickListener {
         ...
         *                 will be a view provided by the com.rainmonth.utils.common.adapter)
         * @param position The position of the view in the com.rainmonth.utils.common.adapter.
         */
