...
import com.rainmonth.utils.constant.RegexConstants;
...
public final class RegexUtils {
    ...
    /**
     * Return whether input matched regex of http(s) url
     *
     * @param input the input
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isHttpOrHttps(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_HTTP_HTTPS_URL, input);
    }
